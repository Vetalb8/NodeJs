...
app.get("/yandex/:cnt/news/for/:search", function (req, res) {
    ...
    var options = {
        ...
        query: {v: "1.0", num: cnt, userip: MY_IP, q: "http://news.yandex.ru/" + search + '.rss'}
    };
    ...
    request(searchUrl, function (err, response, body) {
        ...
        res.render("yandex-news.ejs", {news: news.responseData.feed, category: name, count: cnt});
    });
});